            ...
            <C.FormSection title="Funding Source(s)" isLeftSection>
              {values.parentFlow && values.parentFlow.length ? (
                ...
                >
                  ...
                  fields, remove the Parent flow or make changes directly to the
                  Parent flow at&nbsp;(
                  {values.parentFlow.map((item: any) => (
                    <StyledAnchor
                      href={`flows/edit/${
                        JSON.parse(item?.value ? item?.value.toString() : '').id
                      }/version/${
                        JSON.parse(item?.value ? item?.value.toString() : '')
                          .versionID
                      }`}
                      target="_blank"
                    >
