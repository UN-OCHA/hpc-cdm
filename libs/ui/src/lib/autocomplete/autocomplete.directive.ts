...
@Directive({
  selector: '[hpcAutocomplete]'
})
export class AutocompleteDirective implements OnInit {
  @Input() hpcAutocomplete: AutocompleteComponent;
  ...
  ngOnInit() {
    fromEvent(this.origin, 'focus').pipe(
      ...
      this.hpcAutocomplete.optionsClick()
  ...
  openDropdown() {
    ...
    const template = new TemplatePortal(this.hpcAutocomplete.rootTemplate, this.vcr);
