...
export const OPERATION_FORM_ASSIGNMENTS = `${OPERATIONS}/:operationId/forms/w/:windowId`;
export const OPERATION_FORM_ASSIGNMENT_DATA = `${OPERATIONS}/:operationId/forms/w/:windowId/data/:assignmentId`;
